...
<html>
	...
	<jsp:include page="/jsp/head.jsp"></jsp:include>
			...
			<!--
            	...
            	描述：商品显示
            -->
			<div class="container-fluid"><!-- 分为左右两块 -->
				<!-- 左边是12 -->
				<div class="col-md-12">
			...
			<!-- 咳咳 -->	<a href="${pageContext.request.contextPath }/product?method=getById&pid=${p.pid}">
							<img src="${pageContext.request.contextPath}/${c.pimage}" width="130" height="130" style="display: inline-block;">
						</a>
						<p><a href="${pageContext.request.contextPath }/product?method=getById&pid=${c.pid}" style='color:#666'>${fn:substring(c.pname,0,10)}...</a></p>
