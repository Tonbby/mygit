	...
	<div class="col-md-3" style="padding-top: 20px">
		<ol class="list-inline">
			...
			<c:if test="${not empty user }">
				...
				<li><a
					href="${pageContext.request.contextPath }/order?method=showOrders">我的订单</a></li>
			</c:if>
			<li><a href="${pageContext.request.contextPath }/cart?method=add">购物车</a></li>
		</ol>
	</div>
</div>
<!--
	...
	$(function(){
		...
		$.get("${pageContext.request.contextPath}/category?method=FindAll",function(data){
			...
			$(data).each(function(){
				...
				<!--$ul.append($("<li><a href=${pageContext.request.contextPath}/product?method=getByCid&cid="+this.cid+">"+this.cname+"</a></li>"));-->
			});
		},"json");
	});
</script>
