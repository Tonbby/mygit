...
<html>
	...
	<body>
		...
		<div style="width:380px;margin:0 auto;margin-top:50px;">
			...
			<c:if test="${pbean.currPage != 1 }">
				<li>
					<a href="${pageContext.request.contextPath}/product?method=findByPage&currPage=${pbean.currPage-1}&cid=${param.cid}" aria-label="Previous">
			...
			<!-- 展示所有页码 -->
				...
				<c:if test="${pbean.currPage != pbean.totalPage }">
					<li>
						<a href="${pageContext.request.contextPath}/product?method=findByPage&currPage=${pbean.currPage+1}&cid=${param.cid}" aria-label="Next">
							<span aria-hidden="true">&raquo;</span>
						</a>
					</li>
				</c:if>
